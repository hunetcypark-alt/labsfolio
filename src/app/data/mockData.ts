...
export const MOCK_DESIGNS: Design[] = [
  {
    ...
    company: "삼성전자",
    title: "삼성전자 연수원",
    description: "대기업 맞춤형 브랜드 아이덴티티를 젬린 프리미엄 연수원 디자인. 기업 캐릭터와 CI를 적극 활용해 임직원에게 친숙하고 일관된 학습 경험을 제공합니다.",
    category: "brand",
    industry: "전자/반도체",
  ...
  },
  {
    ...
    company: "롤데그룹",
    title: "롤데그룹 통합 연수원",
    description: "그룹사 계열사를 아우르는 통합 연수원 디자인. 롤데의 브랜드 콜러와 캐릭터를 적극 활용해 친근하고 활기찬 학습 환경을 조성했습니다.",
    category: "brand",
    industry: "유통/식품",
  ...
  },
  {
    ...
    company: "포스코",
    title: "포스코 스마트 연수원",
    description: "제조업 현장 중심의 모바일 최적화 설계. 현장 직원이 스마트 기기로 손쉽게 학습할 수 있도록 직관적인 네비게이션과 오프라인 지원 UI를 갖춰습니다.",
    category: "basic",
    industry: "철강/제조",
